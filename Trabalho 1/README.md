...
- **Main.dart** → Arquivo principal com a lógica do programa e o menu interativo.
- **Classe/Jogador.dart** → Classe `Jogador`, que define os atributos e métodos de cada jogador.
